Sort_Filter_Ascension_Tasks = [
    {
        ...
        "cooldown": 5.0,
            ...
            {
        "task_name": "Select [Green Elemenet] [Sort Filter Ascension]",
        "type": "pixel",
        "click_location_str": "358,143",
        "search_array": ["292,160","#ff9900","269,143","#ffffff","286,142","#ffffff"],
        "isLogical": False,
        "priority": 1,
        "cooldown": 5.0,
    },
        ...
        "type": "pixel",
        "click_location_str": "591,251",
        "search_array": ["621,256","#424f5d","582,252","#ffffff","599,256","#ffffff"],
        "isLogical": False,
        "priority": 1,
        "cooldown": 5.0,
    },
                {
        "task_name": "Click [Confirm] After Checking [Green + Level4] Selected [Sort Filter Ascension]",
        "type": "pixel",
        "click_location_str": "477,491",
        "search_array": ["372,161","#ff9b00","621,256","#ea4b01"],
        "isLogical": False,
        "priority": 1,
        "cooldown": 5.0,
    },
